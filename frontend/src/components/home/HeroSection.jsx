        ...
        <div className="bg-gray-800 text-center py-16 px-4 w-full">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="flex flex-col items-center">
              <div className="bg-blue-500 text-white rounded-full p-4 mb-4 cursor-pointer" onClick={handleOnClick}>
                <svg
            ...
            <div className="flex flex-col items-center">
              <div className="bg-green-500 text-white rounded-full p-4 mb-4 cursor-pointer" onClick={handleOnClick}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="none"
            ...
            <div className="flex flex-col items-center">
              <div className="bg-yellow-500 text-white rounded-full p-4 mb-4 cursor-pointer" onClick={handleOnClick}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="none"
